...
from articles.views import ArticleViewSet, ArticleByTopicViewSet, ArticleByMagazineViewSet, ArticleHistoryViewSet,\
    SaveArticleViewSet, ParseArticleViewSet, BulkHistory, SavedArticlesViewSet, RemoveSavedArticleViewset
...
router.register('articles/saved', SavedArticlesViewSet, base_name='articles/saved')
...
router.register('articles/remove', RemoveSavedArticleViewset, base_name='articles/remove')
